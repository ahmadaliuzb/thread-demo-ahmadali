...
interface UserRepository : BaseRepository<User> {
    ...
    fun findByCheckedFalseAndUuidForEmail(uuidForEmail: String): User?
    fun existsByCheckedTrueAndDeletedFalseAndEmail(email: String): Boolean
    fun existsByCheckedTrueAndDeletedFalseAndUsername(username: String): Boolean
}
