...
class SubscriberNotFoundException : SubscriptionServiceException() {
    override fun errorType() = ErrorCode.SUBSCRIBER_NOT_FOUND
}

class RecipientNotFoundException : SubscriptionServiceException() {
    override fun errorType() = ErrorCode.RECIPIENT_NOT_FOUND
}

class SubscriptionAlreadyExistsException : SubscriptionServiceException() {
    override fun errorType() = ErrorCode.SUBSCRIPTION_ALREADY_EXISTS
}
